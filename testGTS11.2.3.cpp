...
#define GENE_LENGTH 188        // 旋转对称布尔函数的等价类数量
#define FULL_LENGTH 2048       // 13变量布尔函数的全集大小

ofstream process("/Users/mac/Desktop/study/科研/3.18汇报/testGTS/testGTS11.2/改成旋转对称、单点均匀、单点洗牌/process.txt");
ofstream result("/Users/mac/Desktop/study/科研/3.18汇报/testGTS/testGTS11.2/改成旋转对称、单点均匀、单点洗牌/result.txt");
...
int main() {
	...
	int candidate_list_size=3000;//候选列表长度
	int tabu_size=28;//禁忌列表长度
